...
#main-sliders .agile__dot {
  margin: 12px;
}
#main-sliders .agile__dot button {
...
#main-sliders .agile__dot--current button,
#main-sliders .agile__dot:hover button {
